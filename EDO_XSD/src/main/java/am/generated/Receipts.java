...
@XmlType(name = "Receipts", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd", propOrder = {
    "errorHandling",
    "unknownId",
    "success"
})
public class Receipts {
    ...
    @XmlElement(name = "ErrorHandling", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected List<ReceiptErrorHandling> errorHandling;
    @XmlElement(name = "UnknownId", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected List<ReceiptErrorUnknownId> unknownId;
    @XmlElement(name = "Success", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
