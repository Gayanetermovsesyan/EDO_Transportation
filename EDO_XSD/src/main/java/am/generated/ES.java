...
@XmlType(name = "ES", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
public class ES {

    @XmlAttribute(name = "Signatory", required = true)
    protected String signatory;
    @XmlAttribute(name = "ESId", required = true)
    protected String esId;
    @XmlAttribute(name = "ToDocument", required = true)
