...
@XmlType(name = "Document", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd", propOrder = {
    "toDocument",
    "internalID",
    "dealID",
    "number",
...
public class Document {
    ...
    @XmlElement(name = "ToDocument", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected List<String> toDocument;
    @XmlElement(name = "InternalID", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected String internalID;
    @XmlElement(name = "DealID", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected String dealID;
    @XmlElement(name = "Number", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected String number;
    @XmlElement(name = "Date", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd", required = true)
    @XmlSchemaType(name = "date")
    protected XMLGregorianCalendar date;
    @XmlElement(name = "Sum", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected BigDecimal sum;
    @XmlElement(name = "SumVat", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    protected BigDecimal sumVat;
    @XmlElement(name = "AdditionalData", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
    ...
    @XmlAttribute(name = "RecipientSignatureExpected")
