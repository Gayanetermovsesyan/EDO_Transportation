...
import am.team.edo.lm.DocumentType;
...
public class Document {
    ...
    public static class AdditionalData {
        ...
        protected List<AdditionalParam> additionalParam;
         ...
         * 
         */
        public List<AdditionalParam> getAdditionalParam() {
            if (additionalParam == null) {
                additionalParam = new ArrayList<AdditionalParam>();
            }
