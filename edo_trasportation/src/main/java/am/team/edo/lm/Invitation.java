...
import am.team.edo.lm.OrganizationReceiver;
import am.team.edo.lm.OrganizationSender;
import am.team.edo.lm.RequestType;
...
@XmlType(name = "Приглашение", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd", propOrder = {
    "orgSender",
    "orgReceiver",
    "document",
    "es",
...
public class Invitation {
    ...
    @XmlElement(name = "ОргПол", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd", required = true)
    ...
    protected ES es;
    @XmlElement(name = "Комментарий", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
