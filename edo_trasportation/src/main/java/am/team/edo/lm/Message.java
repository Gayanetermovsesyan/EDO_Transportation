...
@XmlRootElement(name = "Сообщение", namespace = "https://roseu.org/upload/iblock/fc7/logical-message-v1.xsd")
...
public class Message {
    ...
    @XmlAttribute(name = "Отправитель", required = true)
    protected String sender;
    @XmlAttribute(name = "Получатель", required = true)
    protected String receiver;
    @XmlAttribute(name = "ИдПодразделенияПолучателя")
